...
@Component({
  selector: 'crng-upload-reactions',
  templateUrl: './upload-reactions.component.html',
  styleUrls: ['./upload-reactions.component.scss'],
})
export class UploadReactionsComponent extends Destroyer {
  state: ImportState = {};
  error?: AppError;
  ...
  sendSample() {
    ...
    downloadBlob(csv, 'reactions.csv', 'text/csv;charset=utf-8;');
  }
}
