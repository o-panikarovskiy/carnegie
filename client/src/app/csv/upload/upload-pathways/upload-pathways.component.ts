...
@Component({
  selector: 'crng-upload-pathways',
  templateUrl: './upload-pathways.component.html',
  styleUrls: ['./upload-pathways.component.scss'],
})
export class UploadPathwaysComponent extends Destroyer {
  state: ImportState = {};
  error?: AppError;
  ...
  sendSample() {
    ...
    downloadBlob(csv, 'pathways.csv', 'text/csv;charset=utf-8;');
  }
}
